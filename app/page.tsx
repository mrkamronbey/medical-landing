    ...
    <>
      ...
      <main className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="hidden sm:block absolute top-[120vh] left-1/2 -translate-x-1/2 w-[900px] h-[600px] bg-primary/3 rounded-full blur-[120px]" />
          <div className="hidden sm:block absolute top-[200vh] -right-32 w-[600px] h-[600px] bg-accent/4 rounded-full blur-[120px]" />
          <div className="hidden sm:block absolute top-[280vh] -left-32 w-[700px] h-[700px] bg-primary/3 rounded-full blur-[120px]" />
          <div className="hidden sm:block absolute top-[360vh] right-0 w-[500px] h-[500px] bg-accent/3 rounded-full blur-[120px]" />
        </div>
        <Hero />
        <DoctorInfo />
